package dev.axziom.features.commands.argument;
...
import dev.axziom.features.commands.CommandExceptions;
...
public class CommandArgumentType implements ArgumentType<Command>, CommandExceptionType {
    ...
    public Command parse(StringReader reader) throws CommandSyntaxException {
        ...
        for (String alias : JewDust.commandManager.getCommandAliases()) {
            if (value.equalsIgnoreCase(alias)) {
                return JewDust.commandManager.getCommand(alias);
            }
        }
