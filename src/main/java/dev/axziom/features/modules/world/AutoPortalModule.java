...
public class AutoPortalModule extends Module {
    ...
    private final Setting<Color>   fillColor    = color("FillColor", 145, 79, 220, 255);
    private final Setting<Color>   outlineColor = color("OutlineColor", 145, 79, 220, 255);
    ...
    public void onDisable() {
        JewDust.placementManager.removeQueuedFor(portalBlocks::contains);
        portalBlocks.clear();
        renderMap.clear();
    }
