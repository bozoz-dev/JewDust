...
public class LogoutSpotsModule extends Module {
    ...
    public Setting<Color>   spotColor = color("SpotColor", 145, 79, 220, 255);
    public Setting<Color>   sideColor = color("SideColor", 145, 79, 220, 255);
    public Setting<Float>   lineWidth = num("LineWidth",    1.5f, 0.5f, 5.0f);
    public Setting<Boolean> showTime  = bool("ShowTime",    true);
    public Setting<Color>   nameColor = color("NameColor", 145, 79, 220, 255);
    ...
    private static class SpotData {
        ...
        SpotData(Player player, ResourceKey<Level> dimension) {
            ...
            this.totemPops = JewDust.playerInfoManager.getTotemPops(player.getUUID());
