...
public class ShadersModule extends Module {
    ...
    public Setting<Color> playerColor     = color("PlayerOutline", 145, 79, 220, 255).setPage("Colors");
    public Setting<Color> friendColor     = color("FriendOutline", 145, 79, 220, 255).setPage("Colors");
    public Setting<Color> monsterColor    = color("MonsterOutline", 145, 79, 220, 255).setPage("Colors");
    public Setting<Color> animalColor     = color("AnimalOutline", 145, 79, 220, 255).setPage("Colors");
    public Setting<Color> itemColor       = color("ItemOutline", 145, 79, 220, 255).setPage("Colors");
    public Setting<Color> crystalColor    = color("CrystalOutline", 145, 79, 220, 255).setPage("Colors");
    public Setting<Color> projectileColor = color("ProjectileOutline", 145, 79, 220, 255).setPage("Colors");
    ...
    public Setting<Color> handColor = color("HandColor", 145, 79, 220, 255).setPage("Hand");
    ...
    public boolean shouldShader(Entity entity) {
        ...
        if (entity instanceof AbstractClientPlayer p && !(entity instanceof LocalPlayer)) {
            boolean friend = JewDust.friendManager.isFriend(p);
            return friend
    ...
    private Color colorFor(Entity entity) {
        if (entity instanceof AbstractClientPlayer p && !(entity instanceof LocalPlayer)) {
            return JewDust.friendManager.isFriend(p) ? friendColor.getValue() : playerColor.getValue();
        }
