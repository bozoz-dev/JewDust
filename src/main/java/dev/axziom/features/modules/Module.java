package dev.axziom.features.modules;
...
import dev.axziom.manager.ConfigManager;
import dev.axziom.util.traits.Jsonable;
import dev.axziom.util.traits.Toggleable;
...
public class Module extends Feature implements Jsonable, Toggleable {
    ...
    public void setDisplayName(String name) {
        Module module = JewDust.moduleManager.getModuleByDisplayName(name);
        Module originalModule = JewDust.moduleManager.getModuleByName(name);
    ...
    public JsonElement toJson() {
        ...
        for (Setting<?> setting : getSettings()) {
            try {
                ...
                JewDust.LOGGER.error("Failed to create JSON field", e);
            }
        }
        return object;
    }
    ...
    public void fromJson(JsonElement element) {
        ...
        if (object.has("Enabled")) {
            try {
                ...
                JewDust.LOGGER.error("Failed to toggle module {} during load", getName(), e);
            }
        }
        for (Setting<?> setting : getSettings()) {
            ...
            try {
                ...
                JewDust.LOGGER.error("Failed to load from JSON", throwable);
            }
        }
    }
