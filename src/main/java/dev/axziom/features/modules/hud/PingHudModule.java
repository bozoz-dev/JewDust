...
import dev.axziom.mixin.client.PlayerTabOverlayAccessor;
...
public class PingHudModule extends HudModule {
    ...
    public void render(Render2DEvent event) {
        ...
        HudClientModule hud = JewDust.moduleManager.getModuleByClass(HudClientModule.class);
    ...
    private Integer parseFromTablist() {
        ...
        Integer fromHeader = parse(accessor.jewdust$getHeader());
        return fromHeader != null ? fromHeader : parse(accessor.jewdust$getFooter());
    }
