...
public class AutoXPModule extends Module {
    ...
    private void throwBottles(int amount) {
        ...
        float pitch = 90f;
        JewDust.rotationManager.submit(new RotationRequest("AutoXP", 40, yaw, pitch, RotationRequest.Mode.SILENT));
        mc.gameMode.ensureHasSentCarriedItem();
        JewDust.swapManager.withSwap(xp, SwapMode.ALTSILENT, SwapPriority.UTILITY, () -> {
