...
public class AutoLogModule extends Module {
    ...
    private Channel getChannel() {
        ...
        return ((dev.axziom.mixin.network.ConnectionAccessor) mc.getConnection().getConnection()).getChannel();
    }
    ...
    private boolean isAutoTotemEnabled() {
        AutoTotemModule autoTotem = JewDust.moduleManager.getModuleByClass(AutoTotemModule.class);
