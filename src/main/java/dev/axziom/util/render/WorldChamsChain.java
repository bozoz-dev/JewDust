...
public final class WorldChamsChain {
    ...
    private static final Identifier H_FSH      = Identifier.fromNamespaceAndPath("jewdust", "post/chams_default_h");
    private static final Identifier C_FSH      = Identifier.fromNamespaceAndPath("jewdust", "post/chams_default_c");
    private static final Identifier V_FSH      = Identifier.fromNamespaceAndPath("jewdust", "post/chams_default_v");
    private static final Identifier CHAMS_H    = Identifier.fromNamespaceAndPath("jewdust", "chams_h");
    private static final Identifier CHAMS_C    = Identifier.fromNamespaceAndPath("jewdust", "chams_c");
    private static final Identifier CHAIN_NAME = Identifier.fromNamespaceAndPath("jewdust", "chams_default_runtime");
    ...
    private static PostChain build(Set<Identifier> externalTargets, int glowThickness, float glowIntensity,
        ...
        try {
            if (projection == null) {
                projection = new CachedOrthoProjectionMatrixBuffer("jewdust_chams", 0.1f, 1000.0f, false);
            }
