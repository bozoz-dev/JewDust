...
public final class SkyboxRenderer {
    private static final Identifier VERTEX_SHADER = Identifier.fromNamespaceAndPath("jewdust", "core/skybox");
    ...
    private static RenderType buildType(SkyboxModule.Mode mode) {
        RenderPipeline pipeline = RenderPipeline.builder()
                ...
                .withFragmentShader(Identifier.fromNamespaceAndPath("jewdust", "core/skybox_" + mode.name().toLowerCase()))
                ...
                .withCull(false)
                .build();
        return RenderType.create("jewdust_skybox_" + mode.name().toLowerCase(),
