...
public final class HandShaderChain {
    ...
    private static final Identifier DILATE_H_FSH      = Identifier.fromNamespaceAndPath("jewdust", "post/hand_outline_h");
    private static final Identifier OUTLINE_FSH       = Identifier.fromNamespaceAndPath("jewdust", "post/hand_outline");
    private static final Identifier GLOW_H_FSH        = Identifier.fromNamespaceAndPath("jewdust", "post/hand_glow_h");
    private static final Identifier OUTLINE_GLOW_FSH  = Identifier.fromNamespaceAndPath("jewdust", "post/hand_outline_glow");
    private static final Identifier DILATED           = Identifier.fromNamespaceAndPath("jewdust", "hand_dilated");
    private static final Identifier GLOW_H            = Identifier.fromNamespaceAndPath("jewdust", "hand_glow_h");
    private static final Identifier CHAIN_NAME        = Identifier.fromNamespaceAndPath("jewdust", "hand_shader_runtime");
    ...
    private static PostChain build(int lineWidth, boolean fill, int glowRadius, float glowIntensity) {
        try {
            if (projection == null) {
                projection = new CachedOrthoProjectionMatrixBuffer("jewdust_hand", 0.1f, 1000.0f, false);
            }
